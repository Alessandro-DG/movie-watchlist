const omdbApiBaseUrl = "http://www.omdbapi.com/?apikey=6de98b2f&"
...
async function fetchMovies() {
    ...
    const res = await fetch(omdbApiBaseUrl + "s=" + searchInput.value)

    if(!res.ok) {
        resultsPlaceholder.innerHTML = "<p>The service is currently unavailable. Please try again later.</p>"
                        ...
                        cardsHtml += `
                            ...
                            <div class="result-section-card-content">
                                ...
                                <div class="result-section-card-duration-genre-btn-container">
                                    ...
                                    <button class="add-to-watchlist-button ${watchlist.includes(movie.imdbID) ? "hidden" : ""}" data-imdbid="${movie.imdbID}">
                                    ...
                                    <button class="remove-from-watchlist-button ${watchlist.includes(movie.imdbID) ? "" : "hidden"}" data-imdbid="${movie.imdbID}">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
